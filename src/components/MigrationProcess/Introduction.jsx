...
const Introduction = () => {
  ...
  return (
    <div className="">
      <div>
        <p>
          <strong>POrtIT</strong> facilitates the seamless migration of
          integrations from SAP PO 7.5 to CPI through an interactive user
      ...
      <div className="mt-6">
        <h3 className="text-xl font-semibold">Salient Features</h3>
      ...
      <div className="mt-4">
        <h3 className="text-xl font-semibold">
          Want to Explore more? Try adding an agent below.
        </h3>
        <button
          className="mt-3 bg-[#0A6ED1] flex flex-row text-white rounded p-2 hover:bg-gray-300 hover:text-black transition duration-200"
