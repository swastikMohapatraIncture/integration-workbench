  ...
  return (
      ...
      <table className="min-w-full divide-y divide-gray-200 border border-gray-300">
        <thead className="bg-gray-50">
          <tr>
            ...
            <th scope="col" className="px-6 py-3 text-left text-s font-bold text-[#32363A] tracking-wider border-r border-gray-200">PO Tenant</th>
            <th scope="col" className="px-6 py-3 text-left text-s font-bold  text-[#32363A] tracking-wider border-r border-gray-200">PO Environment</th>
            <th scope="col" className="px-6 py-3 text-left text-s font-bold  text-[#32363A] tracking-wider border-r border-gray-200">IS Tenant</th>
            <th scope="col" className="px-6 py-3 text-left text-s font-bold  text-[#32363A] tracking-wider border-r border-gray-200">IS Environment</th>
            <th scope="col" className="px-6 py-3 text-left text-s font-bold  text-[#32363A] tracking-wider border-r border-gray-200">Actions</th>
          </tr>
        </thead>
    ...
    <div className="z-50 fixed bottom-14 border-t border-[#E5E5E5] w-[85%] flex items-end pt-3 justify-end pb-2 text-sm">
      <div className="flex gap-2 mr-12">
        <button className=" text-white bg-[#0A6Ed1] rounded-sm px-6 py-2">
          Add System
        </button>
        <Link to="/migrate">
        <button className=" text-white bg-[#0A6Ed1] rounded-sm px-6 py-2" onClick={() => handleMigrate()}>
          Next
        </button>
        </Link>
      </div>
